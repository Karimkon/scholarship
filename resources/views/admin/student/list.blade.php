				...
				<div class="row">
							...
							<div id="list-view" class="tab-pane fade active show col-lg-12">
								<div class="card">
									<div class="card-header">
										...
										<a href="{{ url('admin/student/add/') }}" class="btn btn-primary">+ Add new</a>
									</div>
									<div class="card-body">
										@include('_message')
					...
					<tr>
                      ...
                      <td style="min-width: 270px">
                        <a href="{{ url('admin/student/edit/'.$value->id) }}" class="btn btn-primary btn-sm"><i class="la la-pencil"></i></a>
                        <a href="{{ url('admin/student/delete/'.$value->id) }}" class="btn btn-danger btn-sm"><i class="la la-trash"></a>
